...
# Javascript
## Conventation (Bộ quy tắc)
### 1. snake_case: 
>Viết thường all, ngăn cách bằng dấu gạch dưới

Ex: `vo_thi_thanh_tam`
### 2. kebab-case: 
> Đặt tên file và folder. Viết thường all, ngăn cách bằng dấu gạch ngang

Ex: `vo-thi-thanh-tam`
### 3. camelCase: đặt tên biến, tên hàm
> Chữ đầu viết thường, các chữ sau viết hoa chữ cái đầu tiên

Ex: `voThiThanhTam`
### 4. PascalCasse: 
> Đặt tên class, viết hoa tất cả chữ cái đầu tiên
...
```
## Object
Là ***kiểu dữ liệu*** dùng để lưu trữ dữ liệu dạng **key:value**
...
```
+ Truy xuất giá trị của object: sử dụng dấm chấm (.) or ngoặc vuông ([])
